...
public class Menu {
    ...
    public Menu() {
        ...
        DoadorRepositorio doadorRepositorio = new DoadorRepositorio();
        DoacaoRepositorio doacaoRepositorio = new DoacaoRepositorio();
        Estoque estoque = new Estoque();
        EstoqueRepositorio estoqueRepositorio = new EstoqueRepositorio(estoque);

        this.doadorController = new DoadorController(doadorRepositorio);
        this.estoqueController = new EstoqueController(estoqueRepositorio);
        this.doacaoController = new DoacaoController(doacaoRepositorio, estoqueController);

        this.funcionarioLogado = new Funcionario(
                "Administrador", "000.000.000-00", "68999999999", LocalDate.of(1990, 1, 1), 1001);
    }
    ...
    private void exibirMenu() {
        ...
        System.out.println("8 - Listar bolsas de sangue (detalhado)");
        System.out.println("9 - Listar Doadores");
